...
import posetedBy from '../sanity-backend/schemas/posetedBy';
  ...
  <div className="lg:ml-20 flex gap-4 relative">
    ...
    <Link href={`/detail/${post._id}`}>
      <video src={post.video.asset.url}
        loop
        ref={videoRef}
        className="lg:w-[600px] h-[300px] md:h-[400px] lg:h-[530px] w-[200px] rouded-2xl cursor-pointer bg-gray-100"
      >
